...
from src.schemas.evaluation import DomainResponse, EvaluationStatus, EvaluatorStatus, ConfidenceLevel
...
class TestRepositoryConcurrency:
    ...
    def sample_result(self):
        ...
        return EvaluationResult(
            ...
            latency_ms=100.0,
            response=DomainResponse(evaluation_status=EvaluatorStatus.SUCCESS, score=0.9, confidence=0.9, confidence_level=ConfidenceLevel.HIGH),
        )
...
class TestCostGovernanceConcurrency:
    ...
    def test_concurrent_record_usage(self):
        ...
        expected_cost = expected_records * (100 * 0.00003 + 50 * 0.00006)
    ...
    def test_concurrent_register_no_duplicate(self):
        ...
        class DummyEvaluator(BaseEvaluator):
            def _do_evaluate(self, request):
                return DomainResponse(evaluation_status=EvaluatorStatus.SUCCESS, score=1.0, confidence=0.9, confidence_level=ConfidenceLevel.HIGH)
