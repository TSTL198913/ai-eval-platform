...
async def get_dashboard_stats():
    ...
    try:
        ...
        record_count = svc.count()
        recent_records = svc.get_recent(limit=5)
...
async def get_dashboard_overview():
    ...
    try:
        ...
        svc = get_data_service()
        recent_records = svc.get_recent(limit=100)
