...
import { Model, ModelComparisonResult, EvaluateRequest } from '../types';
import { TrendingUp, Award, Play, RefreshCw } from 'lucide-react';
...
const Models: React.FC = () => {
  ...
  const [history, setHistory] = useState<{ timestamp: number; results: ModelComparisonResult[] }[]>([]);
