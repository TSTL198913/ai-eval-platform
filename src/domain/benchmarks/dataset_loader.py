...
class DatasetLoader:
    ...
    @classmethod
    def load_gsm8k(cls, limit: int | None = None) -> list[dict[str, Any]]:
        """加载GSM8K数学推理数据集"""
    ...
    @classmethod
    def load_humaneval(cls, limit: int | None = None) -> list[dict[str, Any]]:
        """加载HumanEval代码生成数据集"""
    ...
    def get_dataset_info(cls) -> dict[str, Any]:
        ...
        return {
            "mmlu": {
                ...
                "subjects": list({s.get("subject") for s in cls.load_mmlu()}),
