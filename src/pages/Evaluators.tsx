          ...
          <div>
            ...
            <Form form={form} layout='vertical'>
              ...
              >
                <Input.TextArea
                  rows={8}
                  defaultValue={getDefaultPayload(selectedEvaluator.name)}
              ...
              <div className='mt-6 p-4 bg-gray-50 rounded-lg'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-xl font-bold text-blue-600'>{testResult.data?.score ?? '-'}</p>
                  </div>
                  <div>
      ...
      >
        ...
        <Form form={batchForm} layout='vertical'>
          ...
          >
            <Input.TextArea
              rows={10}
              defaultValue={defaultBatchCases}
