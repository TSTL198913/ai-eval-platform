...
class TestClassificationEvaluator:
    ...
    def test_evaluate_with_valid_category(self):
        """测试有效分类"""
        self.mock_client.chat.return_value = "体育"
    ...
    def test_evaluate_partial_match(self):
        ...
        request = EvaluationSchema(
            id="test_001",
            type="classification",
            payload={"user_input": "软件开发", "expected_label": "科技"}
        )
