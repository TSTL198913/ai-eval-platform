...
class ModelPerformanceAnalyzer:
    ...
    def analyze_model_performance(
        self, model_name: str, evaluator_type: str = None, days: int = 7
    ) -> dict[str, Any]:
    ...
    def compare_models(
        self, model_names: list[str], evaluator_type: str = None
    ) -> list[dict[str, Any]]:
        results = []
    ...
    def get_pareto_frontier(self, evaluator_type: str = None) -> list[dict[str, Any]]:
        ...
        sorted_stats = sorted(
            model_stats, key=lambda x: (x["avg_score"], -x["avg_latency_ms"]), reverse=True
        )
    ...
    def get_model_recommendations(
        self, task_type: str, preference: str = "balanced"
    ) -> list[dict[str, Any]]:
