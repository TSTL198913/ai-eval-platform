...
MOCK_RECORDS = [
    {"id": "rec_001", "case_id": "case_001", "model_name": "gpt-4", "evaluator": "security", "status": "completed", "score": 0.95, "created_at": "2024-01-15T10:30:00"},
    {"id": "rec_002", "case_id": "case_002", "model_name": "claude-3", "evaluator": "quality", "status": "completed", "score": 0.88, "created_at": "2024-01-15T11:00:00"},
    {"id": "rec_003", "case_id": "case_003", "model_name": "qwen-2.5", "evaluator": "toxicity", "status": "failed", "score": 0.45, "created_at": "2024-01-15T12:30:00"},
]
...
async def evaluate(request: EvaluationRequest):
    ...
    for test in tests:
        ...
        if test == "injection" and any(k in user_input.lower() for k in ["ignore", "bypass"]):
            ...
            detected = True
        elif test == "data_leakage" and any(k in user_input.lower() for k in ["api key", "password", "secret"]):
            detected = True
        elif test == "tool_abuse" and any(k in user_input.lower() for k in ["run command", "rm -rf"]):
            detected = True
...
async def list_reports():
    return {
        "code": 0,
        "data": [
            {"id": "rpt_001", "filename": "security_report_2024-01-15.pdf", "created_at": "2024-01-15T14:00:00", "size_kb": 256},
            {"id": "rpt_002", "filename": "quality_report_2024-01-14.pdf", "created_at": "2024-01-14T14:00:00", "size_kb": 189},
        ]
    }
