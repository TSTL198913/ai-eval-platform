...
""",
            ...
            try:
                ...
                if result["is_valid"]:
                    ...
                    if total > 100:
                        ...
                        if scores:
                            valid_scores = [s.get("score", 0) for s in scores.values() if isinstance(s, dict)]
                            if valid_scores:
    ...
    def _generate_summary(self, results: list) -> dict:
        ...
        needs_improvement = sorted(
            [r for r in valid_results if r["total_score"] < 80],
    ...
    def generate_fix_priorities(self) -> list:
        ...
        for result in needs_improvement:
            ...
            # 安全性问题优先级更高
            scores = result.get("scores", {})
            security_score = scores.get("security", {}).get("score", 100) if isinstance(scores.get("security"), dict) else 100
            ...
            priorities.append({
                ...
                "priority": "P0" if priority_score >= 50 else "P1" if priority_score >= 30 else "P2",
