...
class Permission(Enum):
    ...
    # 基础权限
    EVALUATE = "evaluate"  # 执行评测
    VIEW_REPORT = "view_report"  # 查看报告
    COMPARE = "compare"  # 模型对比

    # 标注权限
    ANNOTATE = "annotate"  # 执行标注
    REVIEW_ANNOTATION = "review_annotation"  # 审核标注

    # A/B 测试权限
    CREATE_AB_TEST = "create_ab_test"  # 创建 A/B 测试
    MANAGE_AB_TEST = "manage_ab_test"  # 管理 A/B 测试

    # Benchmark 权限
    RUN_BENCHMARK = "run_benchmark"  # 运行基准测试
    VIEW_BENCHMARK = "view_benchmark"  # 查看基准测试

    # 校准权限
    MANAGE_GOLDEN_DATASET = "manage_golden_dataset"  # 管理黄金数据集
    CORRECT_SAMPLE = "correct_sample"  # 修正样本

    # 管理权限
    MANAGE_MODELS = "manage_models"  # 管理模型
    MANAGE_MODEL_VERSIONS = "manage_model_versions"  # 管理模型版本
    MANAGE_EVALUATORS = "manage_evaluators"  # 管理评估器
    MANAGE_EVALUATOR_VERSIONS = "manage_evaluator_versions"  # 管理评估器版本

    # 安全权限
    RUN_SECURITY_TEST = "run_security_test"  # 运行安全测试
    VIEW_SECURITY_REPORT = "view_security_report"  # 查看安全报告
    MANAGE_SECURITY_RULES = "manage_security_rules"  # 管理安全规则

    # 质量权限
    RUN_QUALITY_GATE = "run_quality_gate"  # 运行质量门禁
    MANAGE_QUALITY_CONFIG = "manage_quality_config"  # 管理质量配置

    # 成本权限
    VIEW_COST_REPORT = "view_cost_report"  # 查看成本报告
    MANAGE_BUDGET = "manage_budget"  # 管理预算

    # 元评估权限
    VIEW_META_CONFLICTS = "view_meta_conflicts"  # 查看冲突
    RESOLVE_META_CONFLICT = "resolve_meta_conflict"  # 解决冲突

    # 变异测试权限
    RUN_MUTATION_TEST = "run_mutation_test"  # 运行变异测试
    VIEW_MUTATION_REPORT = "view_mutation_report"  # 查看报告
...
ROLE_PERMISSIONS: dict[Role, list[Permission]] = {
    ...
    Role.PREMIUM: [
        ...
        Permission.VIEW_BENCHMARK,
        Permission.RUN_BENCHMARK,
        Permission.CREATE_AB_TEST,
        Permission.MANAGE_AB_TEST,
    ],
    # 企业用户：完整功能
    Role.ENTERPRISE: [
        Permission.EVALUATE,
        ...
        Permission.CREATE_AB_TEST,
        Permission.MANAGE_AB_TEST,
        Permission.MANAGE_GOLDEN_DATASET,
        Permission.CORRECT_SAMPLE,
    ...
    Role.ADMIN: [
        ...
        Permission.VIEW_META_CONFLICTS,
        Permission.RESOLVE_META_CONFLICT,
        Permission.ADMIN,
    ],
    # 安全管理员
    Role.SECURITY_ADMIN: [
    ...
    Role.QUALITY_ADMIN: [
        Permission.VIEW_REPORT,
        Permission.RUN_QUALITY_GATE,
        Permission.MANAGE_QUALITY_CONFIG,
        Permission.RUN_MUTATION_TEST,
        Permission.VIEW_MUTATION_REPORT,
        Permission.ADMIN,
    ],
    # 财务管理员
    Role.FINANCE_ADMIN: [
